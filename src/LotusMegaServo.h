...
void servo1(int16_t angle){lotus_servo1.attach(_lotus_servo1);lotus_servo1.write(angle);}
void servo2(int16_t angle){lotus_servo2.attach(_lotus_servo2);lotus_servo2.write(angle);}
void servo3(int16_t angle){lotus_servo3.attach(_lotus_servo3);lotus_servo3.write(angle);}
void servo4(int16_t angle){lotus_servo4.attach(_lotus_servo4);lotus_servo4.write(angle);}
void servo5(int16_t angle){lotus_servo5.attach(_lotus_servo5);lotus_servo5.write(angle);}
void servo6(int16_t angle){lotus_servo6.attach(_lotus_servo6);lotus_servo6.write(angle);}
void servo7(int16_t angle){lotus_servo7.attach(_lotus_servo7);lotus_servo7.write(angle);}
void servo8(int16_t angle){lotus_servo8.attach(_lotus_servo8);lotus_servo8.write(angle);}
